...
![Working Proxies](https://img.shields.io/badge/Verified%20Working-1591-success?style=for-the-badge&logo=shield)
![Total Checked](https://img.shields.io/badge/Total%20Checked-256450-blue?style=for-the-badge&logo=speedtest)
![Last Updated](https://img.shields.io/badge/Last%20Update-18.07.2026%2009:21:30-informational?style=for-the-badge&logo=clock)
...
| :--- | :---: | :--- |
| **🌐 HTTP / HTTPS** | `1150` | [http.txt](https://raw.githubusercontent.com/stormsia/proxy-list/main/http.txt) |
| **🛡️ SOCKS4** | `73` | [socks4.txt](https://raw.githubusercontent.com/stormsia/proxy-list/main/socks4.txt) |
| **🔒 SOCKS5** | `368` | [socks5.txt](https://raw.githubusercontent.com/stormsia/proxy-list/main/socks5.txt) |
| **📦 All Combined** | `1591` | [working_proxies.txt](https://raw.githubusercontent.com/stormsia/proxy-list/main/working_proxies.txt) |

### Performance Overview
- **Deduplication Audit Rate:** 100% Unique Addresses
- **Current Success Verification Rate:** `0.62%`
