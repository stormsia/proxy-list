...
![Working Proxies](https://img.shields.io/badge/Verified%20Working-2651-success?style=for-the-badge&logo=shield)
![Total Checked](https://img.shields.io/badge/Total%20Checked-166717-blue?style=for-the-badge&logo=speedtest)
![Last Updated](https://img.shields.io/badge/Last%20Update-27.05.2026%2016:20:22-informational?style=for-the-badge&logo=clock)
...
| :--- | :---: | :--- |
| **🌐 HTTP / HTTPS** | `1465` | [http.txt](https://raw.githubusercontent.com/stormsia/proxy-list/main/http.txt) |
| **🛡️ SOCKS4** | `152` | [socks4.txt](https://raw.githubusercontent.com/stormsia/proxy-list/main/socks4.txt) |
| **🔒 SOCKS5** | `1034` | [socks5.txt](https://raw.githubusercontent.com/stormsia/proxy-list/main/socks5.txt) |
| **📦 All Combined** | `2651` | [working_proxies.txt](https://raw.githubusercontent.com/stormsia/proxy-list/main/working_proxies.txt) |

### Performance Overview
- **Deduplication Audit Rate:** 100% Unique Addresses
- **Current Success Verification Rate:** `1.59%`
